 ...
 */
public class ProductBseInfoDto implements Serializable {
    String productId;
    ...
    public ProductBseInfoDto(String productId, String productRiskLevel, String productType, float productRaiseAmount,
